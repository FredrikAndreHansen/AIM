...
export function invitedUsersView(userName, teamName) {
    return `
        <tr class="tr" id="all-invited-teams">
            <td class="alert-box">
                ...
                <div class="center-align">
                    <button id="accept-button" class="btn-alert"><img class="inside-btn-icon-image" src="../../../graphic/acceptIcon.svg" /> ACCEPT</button>
                    <button id="accept-button" class="btn-alert"><img class="inside-btn-icon-image" src="../../../graphic/declineIcon.svg" /> DECLINE</button>
                </div>
            </td>
        </tr>
    `;
